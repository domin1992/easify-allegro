...
(function($) {
	...
	$.fn.filer.defaults = {
		...
		captions: {
			button: "Wybierz plik",
			feedback: "Wybierz plik do wysłania",
			feedback2: "Plik został wybrany",
			drop: "Upusc plik do wyslania tutaj",
			removeConfirmation: "Are you sure you want to remove this file?",
			errors: {
				filesLimit: "Tylko pliki z rozszerzeniem {{fi-limit}} sa dozwolone.",
				filesType: "Mozna wyslac tylko obrazy.",
				filesSize: "{{fi-name}} jest za duzy. Maksymalny rozmiar pliku to {{fi-maxSize}} MB.",
				filesSizeAll: "Plik jest za duzy. Maksymalny rozmiar pliku to {{fi-maxSize}} MB."
			}
		}
	}
})(jQuery);
